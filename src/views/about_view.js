...
export default function AboutView() {
  return (
    <>
    <div style={{display:'flex',flexDirection:'row',alignItems:'center',width: "50%",alignSelf:'center'}}>
    <img style={{aspectRatio:1,width:100, borderRadius:360,objectFit:'cover'}} alt="Simi" src={Simi} />
    <div style={{
         marginLeft:10,
          color: "white",
        ...
        <h3>Software Developer @Softimpact</h3>
    </div>
    </div>
      <p
        style={{
      ...
      >
        ...
        apps, bounce around Reddit, Lemmy, and Twitch for new ideas and watch TV Shows for entertainment.
      </p>
    </>
  );
}
